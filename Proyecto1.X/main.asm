...
MINUTO_EDITAR RES 1 ;USADA PARA GUARDAR EL VALOR A ESTABLECER AL EDITAR MINUTO
 ...
 ;SE ACTIVA LA ALARMA ESTE ES USADO PARA CONTAR 
;*******************************************************************************
; Reset Vector
;*******************************************************************************
...
TMR2_INT:
    ...
    ;INCF    MINUTOS_TEMPORIZADOR,F
    ;DECF    MINUTOS_TEMPORIZADOR,F
    BTFSS   STATUS,2 ;1 SI LO ANTERIOR DA 0
    GOTO DECREMENTAR_MINUTOS_TEMPORIZADOR
...
OPCIONES:
    ...
    CALL EDITAR_TEMPORIZADOR
     CALL DISPLAY_TEMPORIZADOR_EDITAR
    MOVWF    PORTC
    MOVF    CONTROL_DISPLAY,W
    MOVWF   PORTD
    GOTO LOOP
...
DISPLAY_TEMPORIZADOR:
    ...
    GOTO SEGUNDOS_1_TEMP
    BTFSC   CONTROL_DISPLAY,1
    GOTO SEGUNDOS_2_TEMP
...
DISPLAY_FECHA_EDITAR:
    ...
    MES_2_EDITAR
     BTFSS   FLAGS,4
    GOTO    MES_2_EDITAR_NORMAL
    
    BTFSC   FLAGS,2
    RETLW   .0
    MES_2_EDITAR_NORMAL
    SWAPF   MES_BCD_EDITAR,W 
    ANDLW B'00001111'; SE CONSERVA EL VALOR DEL BIT MENOS SIGNIFICATIVO
    CALL TABLA
    RETURN
...
DISPLAY_TEMPORIZADOR_EDITAR:
    BTFSC   CONTROL_DISPLAY,0 ;VER SI ESTE ESTA ENCENDIDO
    GOTO SEGUNDOS_TEMPORIZADOR_1_EDITAR
    BTFSC   CONTROL_DISPLAY,1
    GOTO SEGUNDOS_TEMPORIZADOR_2_EDITAR
    BTFSC   CONTROL_DISPLAY,2
    GOTO MINUTOS_TEMPORIZADOR_1_EDITAR
    BTFSC   CONTROL_DISPLAY,3
    GOTO MINUTOS_TEMPORIZADOR_2_EDITAR
    
    RETURN
    SEGUNDOS_TEMPORIZADOR_1_EDITAR
    BTFSS   FLAGS,4
    GOTO    SEGUNDOS_TEMPORIZADOR_1_EDITAR_NORMAL
    
    BTFSS   FLAGS,2
    RETLW   .0
    SEGUNDOS_TEMPORIZADOR_1_EDITAR_NORMAL
    MOVF    SEGUNDOS_TEMPORIZADOR_EDITAR,W
    ANDLW   B'00001111' ;SE CONSERVA EL NIBBLE MENOS SIGNFICATIVO
    CALL TABLA
    RETURN
    
    SEGUNDOS_TEMPORIZADOR_2_EDITAR
     BTFSS   FLAGS,4
    GOTO    SEGUNDOS_TEMPORIZADOR_2_EDITAR_NORMAL
    
    BTFSS   FLAGS,2
    RETLW   .0
    SEGUNDOS_TEMPORIZADOR_2_EDITAR_NORMAL
    SWAPF   SEGUNDOS_TEMPORIZADOR_EDITAR,W 
    ANDLW B'00001111'; SE CONSERVA EL VALOR DEL BIT MENOS SIGNIFICATIVO
    CALL TABLA
    RETURN
    
    MINUTOS_TEMPORIZADOR_1_EDITAR
     BTFSS   FLAGS,4
    GOTO    MINUTOS_TEMPORIZADOR_1_EDITAR_NORMAL
    
    BTFSC   FLAGS,2
    RETLW   .0 ;SE APAGAN TODOS LOS BITS DEL PUERTO C
    MINUTOS_TEMPORIZADOR_1_EDITAR_NORMAL
    MOVF MINUTOS_TEMPORIZADOR_EDITAR,W
    ANDLW   B'00001111'
    CALL TABLA
    RETURN
    
    MINUTOS_TEMPORIZADOR_2_EDITAR
    BTFSS   FLAGS,4
    GOTO    MINUTOS_TEMPORIZADOR_2_EDITAR_NORMAL
    
    BTFSC   FLAGS,2
    RETLW   .0 ;SE APAGAN TODOS LOS BITS DEL PUERTO C
    MINUTOS_TEMPORIZADOR_2_EDITAR_NORMAL
    SWAPF   MINUTOS_TEMPORIZADOR_EDITAR,W
    ANDLW   B'00001111'
    CALL TABLA
    RETURN
...
VALOR_TEMPORIZADOR: ;EN ESTA SUBRUTINA UNICAMENTE SE CORRIGEN LOS VALORES BCD
    ...
    MOVLW   B'00001111' ;QUEDARSE CON EL PRIMER DIGITO
    ANDWF   SEGUNDOS_TEMPORIZADOR,W
    SUBLW   .15 ;SI SE PASO DE X0 A (X-1)9 AL RESTAR VA A QUEDAR VALOR 15 EN BINARIO EN ESTE NIBBLE
    BTFSS   STATUS,2 ;SI LO ANTERIOR DA 0 ES QUE SI SE DEBE CORREGIR
    GOTO    DEC_MINUTO_TEMPORIZADOR
    
    MOVLW .6
    SUBWF   SEGUNDOS_TEMPORIZADOR,F; SE COLOCA DE NUEVO EN 9
    
    DEC_MINUTO_TEMPORIZADOR
    MOVLW   B'00001111'
    ANDWF   MINUTOS_TEMPORIZADOR,W
    SUBLW   .15 ;
    BTFSS   STATUS,2 
    RETURN
